...
/**
 * Meta body - Cuboctahedron.
 *
 */
public class CuboctahedronBody extends BodyAdapter {
  private Cuboctahedron3d _Cuboctahedron; // Math object polygon
   ...
   * @param okt
   */
  public CuboctahedronBody(String id, String title, Cuboctahedron3d okt) {
    super(id, title);
    _Cuboctahedron = okt;
    _exists = true;
  }
   ...
   * @throws geom.ExGeom
   */
  public CuboctahedronBody(String id, String title, Vect3d a, Vect3d b, double angle) throws ExGeom {
    super(id, title);
    _Cuboctahedron = new Cuboctahedron3d(a, b, angle);
    _alias = "кубооктаэдр";
    _exists = true;
  }
   ...
   * @param title
   */
  public CuboctahedronBody(String id, String title) {
    super(id, title);
    _alias = "кубооктаэдр";
    _exists = false;
  }
   ...
   */
  public Cuboctahedron3d Cuboctahedron() {
    return _Cuboctahedron;
  }

  // Getters for all vertex of octahedron
  public Vect3d A() {
    return _Cuboctahedron.A();
  }

  public Vect3d B() {
    return _Cuboctahedron.B();
  }

  public Vect3d C() {
    return _Cuboctahedron.C();
  }

  public Vect3d D() {
    return _Cuboctahedron.D();
  }

  public Vect3d topu() {
    return _Cuboctahedron.topu();
  }

  public Vect3d topd() {
    return _Cuboctahedron.topd();
  }

  @Override
  public BodyType type() {
    return BodyType.CUBOCTAHEDRON;
  }
  ...
  public PolygonBody section(String id, PlaneBody p)
    ...
    try {
      Polygon3d poly = _Cuboctahedron.sectionByPlane(new Plane3d(p.normal(), p.point()));
  ...
  public i_Body getBody(String id, String title, i_Geom geom) {
    return new CuboctahedronBody(id, title, (Cuboctahedron3d) geom);
  }
  ...
  public Vect3d intersectWithRay(Render ren, Ray3d ray, double x, double y) {
    return Util.getClosestPointToCamera(_Cuboctahedron.intersect(ray), ren.getCameraPosition().eye());
  }
}
