...
public class Cuboctahedron3d implements i_Geom {
   ...
   * @throws geom.ExGeom
   */
  public Cuboctahedron3d(Vect3d a, Vect3d b, double angle) throws ExGeom {
    this._angle = angle;
  ...
  */
  public Cuboctahedron3d(ArrayList<Vect3d> points) {
    _a = points.get(0);
    _b = points.get(1);
    _c = points.get(2);
    _d = points.get(3);
  ...
  public i_Geom constr(ArrayList<Vect3d> points) {
    return new Cuboctahedron3d(points);
 }
  ...
  public GeomType type() {
    return GeomType.CUBOCTAHEDRON3D;
  }
}
