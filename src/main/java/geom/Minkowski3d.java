 ...
 * @author alexeev
 */
public class Minkowski3d implements i_Geom, i_OrientableGeom {
   ...
   */
  public Minkowski3d(i_Geom a, i_Geom b) throws ExDegeneration {
    a.
   ...
   */
  public Minkowski3d(ArrayList<Vect3d> points) throws ExDegeneration {
   ...
   */
  public static Minkowski3d cube3dByTwoPointsAndAngle(Vect3d a, Vect3d b, double angle)
          throws ExDegeneration {
  ...
  public i_Geom constr(ArrayList<Vect3d> points) {
    Minkowski3d cube = null;
    try {
      cube = new Minkowski3d(points);
