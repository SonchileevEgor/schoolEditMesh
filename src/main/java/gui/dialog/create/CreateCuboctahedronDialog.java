...
public class CreateCuboctahedronDialog extends CreateBodyDialog {
  ...
  public CreateCuboctahedronDialog(EdtController ctrl, i_ErrorHandler errorHandler) {
    super(ctrl, errorHandler, "Задать кубоокаэдр четырьмя вершинами");
